...
export default function ChecklistTab() {
  ...
  // Derived selection: explicit user pick wins, else first app. No setState
  // dance needed — keeps the React 19 purity rule happy.
  const selectedAppId = overrideAppId ?? apps[0]?.ascId ?? null;
  ...
  return (
    <SafeAreaView style={[styles.safe, { backgroundColor: palette.background }]} edges={['top']}>
      ...
      <AppPicker apps={apps} selectedAppId={selectedAppId} onSelect={setOverrideAppId} />
