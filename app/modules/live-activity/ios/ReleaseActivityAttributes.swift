...
/// `targets/widget/ReleaseActivityAttributes.swift`. They define the same
/// logical type but live in two separate Swift modules:
///
///   • Main app (this file)     → module `LiveActivity` (the Expo native module pod)
///   • Widget extension          → module `ReleasePilotWidget`
///
...
/// below, you MUST mirror the change in the widget copy or the activity
